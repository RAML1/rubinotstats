    ...
    <Card className="border-border/50 bg-card/50 backdrop-blur">
      ...
      <CardContent>
        {isEmpty ? (
          ...
          <div className="relative max-h-[400px] overflow-y-auto pr-2 scrollbar-thin">
            {/* Timeline line */}
            <div className="absolute left-[7px] top-0 bottom-0 w-[2px] bg-border/50" />
            ...
            {milestones.map((milestone, index) => {
              ...
              return (
                <div key={index} className="relative pl-8 pb-6 last:pb-0">
                  {/* Timeline dot */}
                  <div className="absolute left-0 top-2 w-[16px] h-[16px] flex items-center justify-center">
                    <div
                      className={`w-3 h-3 rounded-full ${colors.dot} shadow-lg ring-4 ${colors.dotRing}`}
                    />
                  </div>
